// <copyright file="RICOUtils.cs" company="algernon (K. Algernon A. Sheppard)">
...
namespace PloppableRICO
{
    ...
    {
        /// <summary>
        /// Checks if a building AI instance is a Ploppable RICO custom AI.
        /// </summary>
        /// <param name="prefabAI">Building AI instance.</param>
        /// <returns>True if this A is a Ploppable RICO custom AI, false otherwise.</returns>
        internal static bool IsRICOAI(PrivateBuildingAI prefabAI) =>
            prefabAI != null && (prefabAI is GrowableResidentialAI || prefabAI is GrowableCommercialAI || prefabAI is GrowableIndustrialAI || prefabAI is GrowableOfficeAI || prefabAI is GrowableExtractorAI);

        /// <summary>
        /// Checks if a building AI instance has a Ploppable RICO custom non-growable AI.
        /// </summary>
        /// <param name="prefabAI">Building AI instance.</param>
        /// <returns>True if this AI is a Ploppable RICO non-growable custom AI, false otherwise.</returns>
        internal static bool IsRICOPloppableAI(PrivateBuildingAI prefabAI) =>
            prefabAI != null && (prefabAI is PloppableResidentialAI || prefabAI is PloppableCommercialAI || prefabAI is PloppableIndustrialAI || prefabAI is PloppableOfficeAI || prefabAI is PloppableExtractorAI);
        ...
        internal static bool IsADinstalled() => SteamHelper.IsDLCOwned(SteamHelper.DLC.AfterDarkDLC);
        ...
        internal static bool IsGCinstalled() => SteamHelper.IsDLCOwned(SteamHelper.DLC.GreenCitiesDLC);
        ...
        internal static int[] WorkplaceDistributionOf(string service, string subservice, string level)
        {
        ...
        internal static int MaxLevelOf(ItemClass.SubService subService)
        {
            switch (subService)
            {
        ...
        internal static string UICategoryOf(string service, string subservice)
        {
        ...
        internal static string SettingsModPath(string name)
        {
